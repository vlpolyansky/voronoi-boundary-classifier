...
int	get_global_size		(int dimindx);
int	get_global_id		(int dimindx);
int	get_local_size		(int dimindx);
int	get_local_id		(int dimindx);
int	get_num_groups		(int dimindx);
int	get_group_id		(int dimindx);
int	get_global_offset	(int dimindx);
